...
| **Restaurant Preview & Follow** | Ais | Fitur ini menampilkan restoran-restoran beserta deskripsinya. Ditampilkan pula daftar menu yang tersedia. Pengguna dapat memberikan rating yang hasilnya akan terakumuasi sebagai rating restoran dan melakukan _follow-unfollow_ restoran. Daftar restoran yang telah diikuti akan muncul di bagian atas halaman restaurant preview. |
